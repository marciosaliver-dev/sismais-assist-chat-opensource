/**
 * Seed script: 32 KB articles from Content Library v1
 * Source: support-knowledge-squad/output/v1/step-05-content-library.md
 *
 * Usage: npx tsx scripts/seed-kb-articles.ts
 */
...
interface ArticleDef {
  ...
  audience_tier: "tier1" | "tier2" | "tier3";
...
const articles: ArticleDef[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    title: "HT-001: Como fazer login no sistema",
    article_template: "how-to",
    l1_slug: "primeiros-passos",
    l2_name: "Cadastro & Login",
    tags: ["login", "acesso", "senha", "primeiros-passos"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "2 min",
    metadata: { code: "HT-001", version: "1.0" },
...
- FAQ: Meu acesso está pendente de aprovação, o que fazer?`,
  },
  {
    title: "HT-002: Como configurar uma instância WhatsApp",
    article_template: "how-to",
    l1_slug: "whatsapp-canais",
    l2_name: "Instancias WhatsApp",
    tags: ["whatsapp", "instancia", "qr-code", "configuracao"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "5 min",
    metadata: { code: "HT-002", version: "1.0" },
...
- FAQ: Posso usar mais de um número de WhatsApp?`,
  },
  {
    title: "HT-003: Como criar um agente de IA",
    article_template: "how-to",
    l1_slug: "agentes-ia",
    l2_name: "Criacao de Agentes",
    tags: ["agente-ia", "criar", "configurar", "prompt", "rag"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "5 min",
    metadata: { code: "HT-003", version: "1.0" },
...
- Tutorial: Seu primeiro atendimento com IA`,
  ...
  {
    title: "HT-004: Como adicionar um artigo à base de conhecimento",
    article_template: "how-to",
    l1_slug: "base-conhecimento",
    l2_name: "Documentos & Artigos",
    tags: ["base-conhecimento", "artigo", "documento", "embeddings"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "4 min",
    metadata: { code: "HT-004", version: "1.0" },
...
- FAQ: Quanto tempo leva para a IA usar um novo artigo?`,
  },
  {
    title: "HT-005: Como usar o Kanban de atendimentos",
    article_template: "how-to",
    l1_slug: "atendimento",
    l2_name: "Kanban",
    tags: ["kanban", "tickets", "atendimento", "drag-and-drop"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "4 min",
    metadata: { code: "HT-005", version: "1.0" },
...
- Como criar um agente de IA`,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    title: "FAQ-PP-01: Como faço para criar minha conta no Mais Simples?",
    article_template: "faq",
    l1_slug: "primeiros-passos",
    l2_name: "Cadastro & Login",
    tags: ["conta", "cadastro", "registro", "primeiros-passos"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-PP-01", version: "1.0" },
    content: `## Como faço para criar minha conta no Mais Simples?

Para criar sua conta, acesse **app.sismais.com/register** e preencha o formulário com seu nome, e-mail e senha (mínimo 6 caracteres). Após o cadastro, seu acesso passará por uma aprovação do administrador da sua empresa. Você receberá um e-mail de confirmação quando o acesso for liberado. O processo de aprovação costuma levar até 24 horas em dias úteis.`,
  },
  {
    title: "FAQ-PP-02: Qual navegador devo usar para acessar a plataforma?",
    article_template: "faq",
    l1_slug: "primeiros-passos",
    l2_name: "Cadastro & Login",
    tags: ["navegador", "browser", "compatibilidade", "primeiros-passos"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-PP-02", version: "1.0" },
    content: `## Qual navegador devo usar para acessar a plataforma?

Recomendamos o Google Chrome, Microsoft Edge ou Mozilla Firefox em suas versões mais recentes. A plataforma funciona em qualquer navegador moderno, mas o Chrome oferece a melhor experiência. Evite o Internet Explorer, que não é suportado. No celular, você também pode acessar pelo navegador — a plataforma se adapta a telas menores.`,
  },
  {
    title: "FAQ-PP-03: Meu acesso está pendente de aprovação, o que fazer?",
    article_template: "faq",
    l1_slug: "primeiros-passos",
    l2_name: "Aprovacao de Acesso",
    tags: ["acesso", "aprovacao", "pendente", "primeiros-passos"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-PP-03", version: "1.0" },
    content: `## Meu acesso está pendente de aprovação, o que fazer?

Seu cadastro precisa ser aprovado pelo administrador da sua empresa antes de você conseguir acessar o sistema. Isso é uma medida de segurança. Entre em contato com o responsável pela plataforma na sua empresa e peça que acesse **Configurações** > **Equipe** para aprovar seu acesso. Se você é o administrador e está com acesso pendente, entre em contato com o suporte Sismais pelo WhatsApp.`,
  },
  {
    title: "FAQ-PP-04: Esqueci minha senha, como recuperar?",
    article_template: "faq",
    l1_slug: "primeiros-passos",
    l2_name: "Cadastro & Login",
    tags: ["senha", "recuperar", "esqueci", "redefinir"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-PP-04", version: "1.0" },
    content: `## Esqueci minha senha, como recuperar?

Na tela de login, clique em **Esqueci minha senha**, digite seu e-mail cadastrado e clique em **Enviar**. Você receberá um e-mail com um link para criar uma nova senha. O link expira em 1 hora. Se não receber o e-mail, verifique a pasta de spam. Lembre-se: a nova senha precisa ter no mínimo 6 caracteres.`,
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    title: "FAQ-AT-01: Como vejo os atendimentos que estão na fila esperando?",
    article_template: "faq",
    l1_slug: "atendimento",
    l2_name: "Inbox & Fila",
    tags: ["fila", "atendimento", "inbox", "aguardando"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-AT-01", version: "1.0" },
...
Acesse **Atendimento** > **Fila** no menu lateral para ver todos os atendimentos aguardando um atendente. Os itens na fila são organizados por ordem de chegada, com os mais antigos no topo. Você pode clicar em **Assumir** para pegar um atendimento para si. Se sua equipe usa distribuição automática, os tickets serão direcionados conforme as regras configuradas pelo administrador.`,
  ...
  {
    title: "FAQ-AT-02: Como envio uma mensagem para o cliente durante o atendimento?",
    article_template: "faq",
    l1_slug: "atendimento",
    l2_name: "Inbox & Fila",
    tags: ["mensagem", "enviar", "atendimento", "inbox"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-AT-02", version: "1.0" },
    content: `## Como envio uma mensagem para o cliente durante o atendimento?

Abra o ticket do cliente pela **Inbox** ou pelo **Kanban** e digite sua mensagem no campo de texto na parte inferior da conversa. Pressione **Enter** ou clique no botão de enviar. A mensagem será enviada pelo mesmo canal que o cliente usou (WhatsApp, por exemplo). Você também pode enviar imagens, documentos e áudios usando o ícone de anexo ao lado do campo de texto.`,
  },
  {
    title: "FAQ-AT-03: Como finalizo um atendimento?",
    article_template: "faq",
    l1_slug: "atendimento",
    l2_name: "Kanban",
    tags: ["finalizar", "resolver", "ticket", "atendimento"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-AT-03", version: "1.0" },
    content: `## Como finalizo um atendimento?

Para resolver um ticket, abra o atendimento e clique no botão **Resolver** no topo da conversa. Você pode adicionar uma nota de resolução antes de fechar. O cliente receberá uma pesquisa de satisfação (CSAT) automaticamente, se essa função estiver ativada. Tickets resolvidos vão para a coluna "Resolvido" no Kanban e ficam acessíveis no histórico.`,
  },
  {
    title: "FAQ-AT-04: Posso personalizar as colunas do Kanban?",
    article_template: "faq",
    l1_slug: "atendimento",
    l2_name: "Kanban",
    tags: ["kanban", "colunas", "personalizar", "configurar"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-AT-04", version: "1.0" },
    content: `## Posso personalizar as colunas do Kanban?

Sim, o administrador pode personalizar as colunas do Kanban. Acesse **Configurações** > **Categorias** para criar, renomear ou reordenar as etapas do fluxo de atendimento. Cada coluna representa uma etapa e você pode criar quantas precisar para o fluxo da sua empresa (ex.: "Aguardando peça", "Em análise técnica").`,
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    title: "FAQ-IA-01: Quantos agentes de IA posso criar?",
    article_template: "faq",
    l1_slug: "agentes-ia",
    l2_name: "Criacao de Agentes",
    tags: ["agente-ia", "limite", "plano", "quantidade"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-IA-01", version: "1.0" },
    content: `## Quantos agentes de IA posso criar?

A quantidade de agentes depende do seu plano. No plano **Gratuito (GMS)**, você pode criar 1 agente. No plano **PRO (GMS)**, até 5 agentes. No plano **Enterprise (Maxpró)**, agentes ilimitados. Cada agente pode ter uma especialidade diferente (suporte, vendas, financeiro), permitindo que você automatize vários setores do atendimento.`,
  },
  {
    title: "FAQ-IA-02: O que são créditos de IA e como funcionam?",
    article_template: "faq",
    l1_slug: "agentes-ia",
    l2_name: "Criacao de Agentes",
    tags: ["creditos-ia", "tokens", "consumo", "plano"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-IA-02", version: "1.0" },
...
Créditos de IA são a moeda que a plataforma usa para processar as respostas dos agentes. Cada resposta gerada pelo agente consome uma quantidade de créditos que varia conforme o tamanho da conversa. Você pode acompanhar seu consumo em **Configurações** > **Consumo IA**. Quando os créditos acabam, o agente para de responder e o atendimento é direcionado para um humano. Créditos são renovados mensalmente conforme seu plano.`,
  ...
  {
    title: "FAQ-IA-03: Posso testar meu agente antes de colocá-lo para atender clientes?",
    article_template: "faq",
    l1_slug: "agentes-ia",
    l2_name: "Criacao de Agentes",
    tags: ["playground", "testar", "agente-ia", "simulacao"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-IA-03", version: "1.0" },
...
Sim, use o **Playground** para testar qualquer agente. Acesse **Agentes IA** > **Agentes**, clique no agente desejado e depois em **Testar no Playground**. Ali você pode simular conversas reais e ajustar as instruções até ficar satisfeito com as respostas. As conversas do Playground não afetam seus atendimentos reais nem consomem créditos do plano.`,
  ...
  {
    title: "FAQ-IA-04: Como faço para o agente de IA transferir o atendimento para um humano?",
    article_template: "faq",
    l1_slug: "agentes-ia",
    l2_name: "Supervisao & Copilot",
    tags: ["transferir", "humano", "escalar", "agente-ia"],
    difficulty_level: "intermediate",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-IA-04", version: "1.0" },
    content: `## Como faço para o agente de IA transferir o atendimento para um humano?

O agente transfere automaticamente quando não consegue resolver o problema ou quando o cliente pede para falar com um atendente. Você também pode configurar regras de transferência nas instruções do agente, por exemplo: "Se o cliente mencionar cancelamento, transfira para um atendente humano." Na aba **Configurações** do agente, há a opção **Escalar para humano** que define o comportamento padrão de transferência.`,
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    title: "FAQ-BC-01: Para que serve a base de conhecimento?",
    article_template: "faq",
    l1_slug: "base-conhecimento",
    l2_name: "Documentos & Artigos",
    tags: ["base-conhecimento", "rag", "IA", "documentos"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-BC-01", version: "1.0" },
    content: `## Para que serve a base de conhecimento?

A base de conhecimento é o "cérebro" dos seus agentes de IA. Nela você cadastra informações sobre sua empresa, produtos, serviços, políticas e procedimentos. Quando um cliente faz uma pergunta, o agente consulta essa base para dar uma resposta precisa. Quanto mais completa e atualizada a base, melhores serão as respostas da IA. Seus clientes também podem acessar artigos diretamente pela Central do Cliente.`,
  },
  {
    title: "FAQ-BC-02: Quais formatos de arquivo posso usar na base de conhecimento?",
    article_template: "faq",
    l1_slug: "base-conhecimento",
    l2_name: "Documentos & Artigos",
    tags: ["formato", "arquivo", "pdf", "upload", "base-conhecimento"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-BC-02", version: "1.0" },
    content: `## Quais formatos de arquivo posso usar na base de conhecimento?

Você pode adicionar artigos em texto diretamente no editor da plataforma e anexar arquivos em PDF, PNG e JPG. O sistema processa automaticamente o conteúdo dos PDFs para que a IA consiga ler e usar as informações. Recomendamos usar textos diretos no editor sempre que possível, pois o processamento é mais preciso do que em arquivos anexados. O tamanho máximo por arquivo é 10 MB.`,
  },
  {
    title: "FAQ-BC-03: Quanto tempo leva para a IA usar um novo artigo?",
    article_template: "faq",
    l1_slug: "base-conhecimento",
    l2_name: "Documentos & Artigos",
    tags: ["embeddings", "processamento", "tempo", "base-conhecimento"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-BC-03", version: "1.0" },
...
Após salvar e publicar um artigo, o sistema leva até 5 minutos para processar o conteúdo e disponibilizá-lo para os agentes de IA. Esse processamento envolve a geração de embeddings (representações do texto que a IA usa para buscar informações). Você não precisa fazer nada além de salvar — o processo é automático.`,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    title: "FAQ-WPP-01: Posso usar mais de um número de WhatsApp?",
    article_template: "faq",
    l1_slug: "whatsapp-canais",
    l2_name: "Instancias WhatsApp",
    tags: ["whatsapp", "multiplos-numeros", "instancias"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-WPP-01", version: "1.0" },
...
Sim, você pode conectar múltiplas instâncias WhatsApp na plataforma. Cada instância representa um número diferente. Isso é útil se você tem setores separados (ex.: um número para vendas, outro para suporte). Acesse **WhatsApp & Canais** > **Instâncias** para gerenciar todas as suas conexões. A quantidade de instâncias disponíveis depende do seu plano.`,
  ...
  {
    title: "FAQ-WPP-02: O WhatsApp do meu celular vai parar de funcionar se eu conectar à plataforma?",
    article_template: "faq",
    l1_slug: "whatsapp-canais",
    l2_name: "Instancias WhatsApp",
    tags: ["whatsapp", "celular", "dispositivo", "funcionamento"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-WPP-02", version: "1.0" },
    content: `## O WhatsApp do meu celular vai parar de funcionar se eu conectar à plataforma?

Não, seu WhatsApp continua funcionando normalmente no celular. A plataforma se conecta como um dispositivo adicional, igual ao WhatsApp Web. Você pode usar o celular e a plataforma ao mesmo tempo. Porém, mensagens enviadas pela plataforma aparecerão no seu celular e vice-versa. Recomendamos responder apenas pela plataforma para manter o histórico organizado.`,
  },
  {
    title: "FAQ-WPP-03: As mensagens antigas do WhatsApp vão aparecer na plataforma?",
    article_template: "faq",
    l1_slug: "whatsapp-canais",
    l2_name: "Mensagens & Contatos",
    tags: ["whatsapp", "historico", "mensagens-antigas"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-WPP-03", version: "1.0" },
    content: `## As mensagens antigas do WhatsApp vão aparecer na plataforma?

Não, a plataforma só recebe mensagens novas a partir do momento em que a instância é conectada. Mensagens anteriores à conexão não são importadas. Se precisar do histórico anterior, ele continua disponível no WhatsApp do celular normalmente.`,
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    title: "FAQ-CF-01: Como adiciono novos membros à minha equipe?",
    article_template: "faq",
    l1_slug: "configuracoes",
    l2_name: "Equipe & Permissoes",
    tags: ["equipe", "convidar", "membro", "permissoes"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-CF-01", version: "1.0" },
    content: `## Como adiciono novos membros à minha equipe?

Acesse **Configurações** > **Equipe** e clique em **+ Convidar membro**. Digite o e-mail da pessoa e selecione o perfil de acesso (Administrador, Atendente ou Visualizador). A pessoa receberá um convite por e-mail para criar a conta. Após o cadastro, você precisa aprovar o acesso na mesma tela de Equipe.`,
  },
  {
    title: "FAQ-CF-02: Como altero o horário de funcionamento do atendimento?",
    article_template: "faq",
    l1_slug: "configuracoes",
    l2_name: "Gerais",
    tags: ["horario", "funcionamento", "configuracoes", "ausencia"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "1 min",
    metadata: { code: "FAQ-CF-02", version: "1.0" },
    content: `## Como altero o horário de funcionamento do atendimento?

Acesse **Configurações** > **Geral** > **Horário de atendimento**. Defina os dias e horários em que sua equipe está disponível. Fora desse horário, o sistema pode responder automaticamente com uma mensagem de ausência ou continuar com atendimento apenas por IA. Você também pode configurar **feriados** em **Configurações** > **Feriados** para que a plataforma considere esses dias como não-úteis.`,
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    title: "TS-001: IA não responde ou responde errado",
    article_template: "troubleshooting",
    l1_slug: "agentes-ia",
    l2_name: "Criacao de Agentes",
    tags: ["ia", "erro", "nao-responde", "resposta-errada", "troubleshooting"],
    difficulty_level: "intermediate",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "5 min",
    metadata: { code: "TS-001", version: "1.0", severity: "Alta" },
...
- Configure alertas de créditos baixos (quando disponível no plano)`,
  },
  {
    title: "TS-002: WhatsApp não conecta ou não envia mensagens",
    article_template: "troubleshooting",
    l1_slug: "whatsapp-canais",
    l2_name: "Instancias WhatsApp",
    tags: ["whatsapp", "desconectado", "nao-envia", "webhook", "troubleshooting"],
    difficulty_level: "intermediate",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "5 min",
    metadata: { code: "TS-002", version: "1.0", severity: "Critica" },
...
- Configure alertas de desconexão (quando disponível)`,
  },
  {
    title: "TS-003: Sincronização GL falha",
    article_template: "troubleshooting",
    l1_slug: "crm-clientes",
    l2_name: "Sincronizacao GL",
    tags: ["sincronizacao", "gl", "erp", "falha", "troubleshooting"],
    difficulty_level: "intermediate",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "5 min",
    metadata: { code: "TS-003", version: "1.0", severity: "Alta" },
...
- Monitore os logs de sincronização em **Sistema** > **Auditoria** após cada sincronização`,
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    title: "TUT-001: Seu primeiro atendimento com IA — do zero ao ticket resolvido",
    article_template: "tutorial",
    l1_slug: "atendimento",
    l2_name: "Inbox & Fila",
    tags: ["tutorial", "primeiro-atendimento", "ia", "passo-a-passo", "onboarding"],
    difficulty_level: "beginner",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "20 min",
    metadata: { code: "TUT-001", version: "1.0" },
...
- Acompanhe as métricas no **Dashboard** e em **Relatórios**`,
  },
  {
    title: "TUT-002: Criando seu primeiro fluxo de automação",
    article_template: "tutorial",
    l1_slug: "agentes-ia",
    l2_name: "Automacoes & Flows",
    tags: ["tutorial", "flow-builder", "automacao", "boas-vindas", "fluxo"],
    difficulty_level: "intermediate",
    audience_tier: "tier1",
    visibility: "public",
    rag_chunks: true,
    estimated_time: "15 min",
    metadata: { code: "TUT-002", version: "1.0" },
...
- Acompanhe o desempenho dos fluxos em **Relatórios** > **Automações**`,
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    title: "PROC-001: Procedimento — Escalar atendimento de IA para humano",
    article_template: "internal-procedure",
    l1_slug: "atendimento",
    l2_name: "Inbox & Fila",
    tags: ["procedimento", "escalacao", "ia-para-humano", "interno"],
    difficulty_level: "intermediate",
    audience_tier: "tier2",
    visibility: "internal",
    rag_chunks: false,
    estimated_time: "5 min",
    metadata: { code: "PROC-001", version: "1.0" },
...
- **Feedback para IA:** Se a IA errou por falta de conteúdo, registre qual informação faltou — isso prioriza a criação de novos artigos.`,
  },
  {
    title: "PROC-002: Procedimento — Atualizar base de conhecimento após resolver ticket",
    article_template: "internal-procedure",
    l1_slug: "base-conhecimento",
    l2_name: "Documentos & Artigos",
    tags: ["procedimento", "kcs", "base-conhecimento", "atualizar", "interno"],
    difficulty_level: "intermediate",
    audience_tier: "tier2",
    visibility: "internal",
    rag_chunks: false,
    estimated_time: "5 min",
    metadata: { code: "PROC-002", version: "1.0" },
...
- **Prioridade de criação:**
  ...
  3. Informações complementares que enriquecem respostas existentes`,
  },
];
...
async function main() {
  console.log("=== KB Article Seed Script ===");
  console.log(`Total articles to seed: ${articles.length}`);
  console.log("");

  // 1. Cache product_id by slug
  const { data: products, error: prodErr } = await supabase
    .from("knowledge_products")
    .select("id, slug");

  if (prodErr || !products) {
    console.error("Failed to fetch knowledge_products:", prodErr);
    process.exit(1);
  }

  const productBySlug = new Map(products.map((p) => [p.slug, p.id]));
  console.log(`Loaded ${products.length} knowledge_products`);

  // 2. Cache group_id by composite key "name|product_id"
  const { data: groups, error: grpErr } = await supabase
    .from("knowledge_groups")
    .select("id, name, product_id");

  if (grpErr || !groups) {
    console.error("Failed to fetch knowledge_groups:", grpErr);
    process.exit(1);
  }

  const groupByKey = new Map(groups.map((g) => [`${g.name}|${g.product_id}`, g.id]));
  console.log(`Loaded ${groups.length} knowledge_groups`);
  console.log("");
  ...
  for (const article of articles) {
    const productId = productBySlug.get(article.l1_slug);
    if (!productId) {
      console.error(`[SKIP] No product for slug "${article.l1_slug}" — ${article.title}`);
      skipped++;
      continue;
    }

    const groupId = groupByKey.get(`${article.l2_name}|${productId}`);
    if (!groupId) {
      console.error(`[SKIP] No group "${article.l2_name}" under product "${article.l1_slug}" — ${article.title}`);
      skipped++;
      continue;
    }
      ...
      .upsert(
        {
          ...
          category: categoryMap[article.article_template] || article.article_template,
          product_id: productId,
          group_id: groupId,
          tags: article.tags,
          is_active: true,
          feeds_ai: true,
          source: "seed-kb-articles",
          ...
          // metadata stored in description as JSON string for now
          description: JSON.stringify(article.metadata),
        },
        { onConflict: "title" }
      )
      .select("id")
    ...
    if (insErr) {
      console.error(`[ERROR] ${article.title}: ${insErr.message}`);
      errors++;
      continue;
    }

    console.log(`[OK] ${article.title} (${row.id})`);
    inserted++;

    if (article.rag_chunks && row.id) {
      embeddingQueue.push(row.id);
    }
  }

  // 5. Generate embeddings for articles with rag_chunks=true
  console.log("");
  console.log(`Generating embeddings for ${embeddingQueue.length} articles...`);

  let embeddingsOk = 0;
  let embeddingsFail = 0;

  for (const docId of embeddingQueue) {
    const { error: embErr } = await supabase.functions.invoke("generate-embedding", {
      body: { document_id: docId },
    });

    if (embErr) {
      console.error(`[EMB-FAIL] ${docId}: ${embErr.message}`);
      embeddingsFail++;
    } else {
      console.log(`[EMB-OK] ${docId}`);
      embeddingsOk++;
    }
  }
  ...
  console.log("");
  console.log("=== Summary ===");
  console.log(`Articles inserted/updated: ${inserted}`);
  console.log(`Articles skipped:          ${skipped}`);
  console.log(`Articles with errors:      ${errors}`);
  console.log(`Embeddings generated:      ${embeddingsOk}`);
  console.log(`Embeddings failed:         ${embeddingsFail}`);
  console.log(`Total:                     ${inserted + skipped + errors} / ${articles.length}`);
}
